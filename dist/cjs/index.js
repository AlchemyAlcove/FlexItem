...
var _Object$assign = __webpack_require__(/*! @babel/runtime-corejs3/core-js/object/assign */ "./node_modules/@babel/runtime-corejs3/core-js/object/assign.js");
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__["default"])("div", {
  target: "edlxpeq0"
})("&.flex-grid{position:relative;display:flex;max-width:", props => (props.theme.dimensions || {}).containerWidth || 1200, "px;justify-content:flex-start;flex-wrap:wrap;margin:0 auto;width:100%;&.flex-grid-container{margin-left:-", props => (props.theme.dimensions || {}).columnPadding || 3, "px;margin-right:-", props => (props.theme.dimensions || {}).columnPadding || 3, "px;width:calc(100% + ", props => ((props.theme.dimensions || {}).columnPadding || 3) * 2, "px);max-width:calc(100% + ", props => ((props.theme.dimensions || {}).columnPadding || 3) * 2, "px);>.flex-item{padding-left:", props => (props.theme.dimensions || {}).columnPadding || 3, "px;padding-right:", props => (props.theme.dimensions || {}).columnPadding || 3, "px;}}&.flex-grid-vertical-container{margin-top:-", props => (props.theme.dimensions || {}).columnPadding || 3, "px;margin-bottom:-", props => (props.theme.dimensions || {}).columnPadding || 3, "px;>.flex-item{padding-top:", props => (props.theme.dimensions || {}).columnPadding || 3, "px;padding-bottom:", props => (props.theme.dimensions || {}).columnPadding || 3, "px;}}}"));
...
/* harmony import */ var _flex_style__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./flex.style */ "./src/flexGrid/flex.style.js");
...
class FlexGrid extends react__WEBPACK_IMPORTED_MODULE_4___default.a.Component {
  calcMaxPerRow(children) {
    let max = 0;

    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(children).call(children, child => {
      if (!Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(child) && !Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(child.props) && !Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(child.props.size)) {
        max += child.props.size;
      } else if (!Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(child)) {
        max++;
      }
    });
  ...
  renderItems(children) {
    if (Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(children)) {
      return null;
    } else if (Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isArray"])(children)) {
      return _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1___default()(children).call(children, (element, index) => {
  ...
  renderItem(item, index, length) {
    if (Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(item)) {
      return null;
    } else if (Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isArray"])(item)) {
      return this.renderItems(item);
    } else {
      const props = { ...item.props
      };

      if (!Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(item.type) && !Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(item.type.displayName)) {
        let maxPerRow = this.props.maxPerRow || length;

        if (this.props.theme.aspect === "mobile" && !Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(this.props.maxMobileRow)) {
          maxPerRow = this.props.maxMobileRow;
        } else if (this.props.theme.aspect === "tablet" && !Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(this.props.maxTabletRow)) {
      ...
      return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_7__["jsx"])(item.type, _babel_runtime_corejs3_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        key: index
      }, props));
    }
  }
  ...
  render() {
    ...
    if (!Object(lodash__WEBPACK_IMPORTED_MODULE_6__["isNil"])(this.props.className)) {
      classes = classes + " " + this.props.className;
    }

    return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_7__["jsx"])(_flex_style__WEBPACK_IMPORTED_MODULE_5__["default"], {
      className: classes,
...
FlexGrid.propTypes = {
  ...
  maxMobileRow: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.number,
  maxPerRow: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.number,
  maxTabletRow: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.number,
  style: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.object,
  verticalContainer: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.bool
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_emotion_react__WEBPACK_IMPORTED_MODULE_7__["withTheme"])(FlexGrid));

/***/ }),

/***/ "./src/flexItem/flex.style.js":
/*!************************************!*\
  !*** ./src/flexItem/flex.style.js ***!
  \************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__["default"])("div", {
  ...
  name: "1zycjh",
  styles: "&.flex-item{position:relative;display:flex;flex-direction:column;margin:0;max-width:100%;}",
  toString: _EMOTION_STRINGIFIED_CSS_ERROR__
}));

/***/ }),

/***/ "./src/flexItem/index.js":
/*!*******************************!*\
  !*** ./src/flexItem/index.js ***!
  \*******************************/
/*! exports provided: default */
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _flex_style__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./flex.style */ "./src/flexItem/flex.style.js");
...
class FlexItem extends react__WEBPACK_IMPORTED_MODULE_1___default.a.Component {
  render() {
    let classes = "flex-item";

    if (!Object(lodash__WEBPACK_IMPORTED_MODULE_3__["isNil"])(this.props.className)) {
      classes = classes + " " + this.props.className;
    }

    let size = this.props.size;
    const style = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this.props.style);
    ...
    return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_4__["jsx"])(_flex_style__WEBPACK_IMPORTED_MODULE_2__["default"], {
      className: classes,
      style: style
    }, this.props.children);
  }
...
FlexItem.propTypes = {
  ...
  maxPerRow: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,
  mobileSize: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,
  size: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number,
  style: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.object,
  tabletSize: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.number
};
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_emotion_react__WEBPACK_IMPORTED_MODULE_4__["withTheme"])(FlexItem));
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: FlexGrid, FlexItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _flexGrid__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./flexGrid */ "./src/flexGrid/index.js");
...
/* harmony import */ var _flexItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./flexItem */ "./src/flexItem/index.js");
