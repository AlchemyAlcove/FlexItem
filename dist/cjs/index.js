...
/* harmony default export */ __webpack_exports__["default"] = (Object(_emotion_styled_base__WEBPACK_IMPORTED_MODULE_0__["default"])("div", {
  target: "edlxpeq0"
})("&.flex-grid{position:relative;display:flex;max-width:", props => (props.theme.dimensions || {}).containerWidth || 1200, "px;justify-content:flex-start;flex-wrap:wrap;margin:0 auto;width:100%;&.flex-grid-container{column-gap:", props => (props.theme.dimensions || {}).columnPadding || 6, "px;.flex-item{flex-grow:1;}}&.flex-grid-vertical-container{row-gap:", props => (props.theme.dimensions || {}).columnPadding || 6, "px;}}"));
...
const FlexGrid = props => {
  ...
  const theme = Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["useTheme"])();
  const [maxPerRow] = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(() => calcMaxPerRow(props.children));

  function calcMaxPerRow(children) {
    var _children$forEach;

    let max = 0;
    (_children$forEach = _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_2___default()(children)) === null || _children$forEach === void 0 ? void 0 : _children$forEach.call(children, child => {
      var _child$props$size, _child$props;

      max += (_child$props$size = child === null || child === void 0 ? void 0 : (_child$props = child.props) === null || _child$props === void 0 ? void 0 : _child$props.size) !== null && _child$props$size !== void 0 ? _child$props$size : 1;
    });
    return max || 1;
  }
  ...
  function renderItem(item) {
    ...
    if (react__WEBPACK_IMPORTED_MODULE_4___default.a.isValidElement(item) && ((_item$type = item.type) === null || _item$type === void 0 ? void 0 : _item$type.displayName) === "FlexItem") {
      const childProps = { ...item.props,
        isParentContainer: props.container
      };
      ...
      return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(item.type, childProps);
    }

    return item;
  }

  const classes = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_1___default()(_context = ["flex-grid", props.container && "flex-grid-container", props.verticalContainer && "flex-grid-vertical-container", props.className]).call(_context, Boolean).join(" ");

  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(_flex_style__WEBPACK_IMPORTED_MODULE_5__["default"], {
    className: classes,
    css: props.style
  }, _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(_context2 = react__WEBPACK_IMPORTED_MODULE_4___default.a.Children).call(_context2, props.children, renderItem));
};
...
/* harmony import */ var _flex_style__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./flex.style */ "./src/flexItem/flex.style.js");
...
const FlexItem = props => {
  ...
  const theme = Object(_emotion_react__WEBPACK_IMPORTED_MODULE_4__["useTheme"])();

  const classes = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_0___default()(_context = ["flex-item", props.className]).call(_context, Boolean).join(" ");

  const size = (_props$ = props[`${theme.aspect}Size`]) !== null && _props$ !== void 0 ? _props$ : props.size;
  ...
  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_4__["jsx"])(_flex_style__WEBPACK_IMPORTED_MODULE_3__["default"], {
    className: classes,
    css: style
  }, props.children);
};
...
FlexItem.propTypes = {
  ...
  maxPerRow: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
  mobileSize: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
  size: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
  style: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object,
  tabletSize: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number
};
...
module.exports = require("emotionReact");
